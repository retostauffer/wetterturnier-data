...
# -*- coding: utf-8 -*-
#
# Wetterturnier documentation build configuration file, created by
# sphinx-quickstart on Wed Jan 17 01:36:44 2018.
#
...
sys.path.append("../CreateSynopSymbols/PyModules");
sys.path.append("../CreateSynopSymbols");
...
#print("pywetterturnier: {0:s}".format(pywetterturnier.__file__))
...
htmlhelp_basename = 'Wetterturnierdoc'
